...
// LED Pins
constexpr int LED_PIN1 = 27;
constexpr int LED_PIN2 = 14;
constexpr int LED_PIN3 = 12;
constexpr int LED_PIN4 = 4;
constexpr int LED_PIN5 = 2;

// WiFi and ThingsBoard Configuration
constexpr char WIFI_SSID[] = "IoTSena";
constexpr char WIFI_PASSWORD[] = "SenaSenaIOT";
constexpr char TOKEN[] = "NWy1X3tk1KCJxtFpdQ6t";
constexpr char THINGSBOARD_SERVER[] = "192.168.1.99";
